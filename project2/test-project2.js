...
var testModule = (function () {
  ...
  // Return the necessary symbols as an object
  return {
    p1Message: p1Message,
    p2Message: p2Message,
    p3Message: p3Message,
...
window.Project2Results = {
  p1Message: testModule.p1Message,
  p2Message: testModule.p2Message,
  p3Message: testModule.p3Message,
};
...
window.onload = function () {
  document.getElementById("p1").innerHTML = testModule.p1Message;
  document.getElementById("p2").innerHTML = testModule.p2Message;
  document.getElementById("p3").innerHTML = testModule.p3Message;
};